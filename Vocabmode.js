const questions = [
    ...
    },
    {
        question:[
            "Perspicacious", //word
            "(having keen judgment; discerning)",
    ...
    },
{
        question:[
            " implore", //word
            "(to ask earnestly for; to beg (a person) to do something)", //definition
    ...
    },
{
        question:[
            " opulent", //word
            "( very wealthy; abundant)", //definition
    ...
    },
{
        question:[
            " contemplate", //word
            "( to look at or think about intently; to expect or intend)", //definition
    ...
    },
{
        question:[
            " asinine", //word
            "( like an ass; stupid; silly)", //definition
        ...
        answers: [
            ...
            { text: " silly or stupid", correct: true},
        ]
    },
{
        question:[
            " aspire", //word
            "to be ambitious (to get or do something); seek (after)", //definition
    ...
    },
{
        question:[
            " baleful", //word
            "( deadly; harmful; ominous)", //definition
    ...
    },
{
        question:[
            " chutney", //word
            "(a relish of fruits, spices, herbs and vinegar)", //definition
...
question:[
            " domineer", //word
            "( to rule (over) in a harsh or arrogant way; tyrannize)", //definition
        ...
        answers: [
            ...
            { text: "to rule over in a harsh way", correct: true},
        ]
    },
{
        question:[
    ...
    },
{
        question:[
            " finagle", //word
            "(to get by, or use, craftiness, trickery, etc.)", //definition
    ...
    },
{
        question:[
            " guile", //word
            "(slyness and cunning in dealing with others)", //definition
    ...
    },
{
        question:[
            "insouciant", //word
            "(calm and untroubled; carefree)", //definition
    ...
    },
{
        question:[
            "jobber", //word
            "(one who buys goods in quantity and sells them to dealers; wholesaler; one who works by the job or does piecework)", //definition
            "All the businesses had to go through the jobbers.",  //sentence
            "Which definition does not describe the word ‘jobber’?", //question
        ],
        answers: [
            { text: "one who works by the job or does piecework", correct: false}, 
    ...
    },
{
        question:[
            "lachrymose", //word
            "(shedding or causing to shed, tears; tearful or sad)", //definition
